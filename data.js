/*
  ...
  4. Не меняйте id узлов, если не уверены: на них ссылаются варианты next.
*/
...
window.DECISION_TREE = {
  ...
  nodes: {
    ...
    "r-manager-name": {
      type: "result",
      code: "ФИО менеджера",
      title: "Указать ФИО менеджера",
      description: "Для клиентского заказа отдела продаж в качестве аналитики укажите ФИО менеджера.",
      tone: "Проверьте, что выбран корректный менеджер по заказу покупателя.",
      status: "ready"
    },
    "r-project-name": {
      type: "result",
      code: "Название проекта",
      title: "Указать название проекта",
      description: "Для автоматизации укажите название проекта, например: «Хлебпром Волоколамск», «ЯКАИБН» и т.д.",
      tone: "Если проект неочевиден, уточните у ответственного за заказ.",
      status: "ready"
    },
    "r-2-1-sales-supplier": {
      type: "result",
      code: "2.1",
      title: "Оплата поставщикам (отдел продаж)",
      description: "Используйте статью 2.1. Оплата поставщикам (отдел продаж).",
      status: "ready"
    },
    "r-3-1-automation-supplier": {
      type: "result",
      code: "3.1",
      title: "Оплата поставщикам (Автоматизация)",
      description: "Используйте статью 3.1. Оплата поставщикам (Автоматизация).",
      status: "ready"
    },
    "r-2-5-sales-other": {
      type: "result",
      code: "2.5",
      title: "Разное (отдел продаж)",
      description: "Используйте статью 2.5. Разное (отдел продаж).",
      status: "ready"
    },
    "r-3-6-automation-other": {
      type: "result",
      code: "3.6",
      title: "Разное (Автоматизация)",
      description: "Используйте статью 3.6. Разное (Автоматизация).",
      status: "ready"
    },
    "r-3-4-automation-rd": {
      type: "result",
      code: "3.4",
      title: "ОКР и оснащение (Автоматизация)",
      description: "Используйте статью 3.4. ОКР и оснащение (Автоматизация).",
      status: "ready"
    },
    "r-1-2-office-maintenance": {
      type: "result",
      code: "1.2",
      title: "Обслуживание офиса",
      description: "Используйте статью 1.2. Обслуживание офиса.",
      status: "ready"
    },
    "r-2-6-sales-recruiting": {
      type: "result",
      code: "2.6",
      title: "Поиск персонала / кадры (отдел продаж)",
      description: "Используйте статью 2.6. Поиск персонала (кадры) (отдел продаж).",
      status: "ready"
    },
    "r-2-3-sales-tenders": {
      type: "result",
      code: "2.3",
      title: "Тендеры (отдел продаж)",
      description: "Используйте статью 2.3. Тендеры (отдел продаж).",
      status: "ready"
    },
    "r-2-2-sales-marketing": {
      type: "result",
      code: "2.2",
      title: "Реклама и маркетинг (отдел продаж)",
      description: "Используйте статью 2.2. Реклама и маркетинг (отдел продаж).",
      status: "ready"
    },
    "r-2-4-sales-transport": {
      type: "result",
      code: "2.4",
      title: "Транспортные расходы (отдел продаж)",
      description: "Используйте статью 2.4. Транспортные расходы (отдел продаж).",
      status: "ready"
    },
    "r-3-3-automation-marketing": {
      type: "result",
      code: "3.3",
      title: "Реклама и маркетинг (Автоматизация)",
      description: "Используйте статью 3.3. Реклама и маркетинг (Автоматизация).",
      status: "ready"
    },
    "r-3-7-automation-recruiting": {
      type: "result",
      code: "3.7",
      title: "Поиск персонала / кадры (Автоматизация)",
      description: "Используйте статью 3.7. Поиск персонала (кадры) (Автоматизация).",
      status: "ready"
    },
    "r-3-5-automation-transport": {
      type: "result",
      code: "3.5",
      title: "Транспортные расходы (Автоматизация)",
      description: "Используйте статью 3.5. Транспортные расходы (Автоматизация).",
      status: "ready"
    },
    "r-3-9-automation-office-trips": {
      type: "result",
      code: "3.9",
      title: "Командировки офис (Автоматизация)",
      description: "Используйте статью 3.9. Командировки офис (Автоматизация).",
      status: "ready"
    },
    "r-3-2-automation-trips": {
      type: "result",
      code: "3.2",
      title: "Командировки (Автоматизация)",
      description: "Используйте статью 3.2. Командировки (Автоматизация).",
      status: "ready"
    },
    "r-1-4-general-recruiting": {
      type: "result",
      code: "1.4",
      title: "Поиск персонала / кадры",
      description: "Используйте статью 1.4. Поиск персонала (кадры).",
      status: "ready"
    },
    "r-1-1-rent": {
      type: "result",
      ...
      description: "Используйте статью 1.1. Аренда помещений.",
      status: "ready"
    },
    "r-1-7-training": {
      type: "result",
      code: "1.7",
      title: "Обучение",
      description: "Используйте статью 1.7. Обучение.",
      status: "ready"
    },
    "r-1-11-corporate": {
      type: "result",
      code: "1.11",
      title: "Корпоративные радости",
      description: "Используйте статью 1.11. Корпоративные радости.",
      status: "ready"
    },
    "r-1-12-representation": {
      ...
      description: "Используйте статью 1.12. Представительские расходы.",
      status: "ready"
    },
    "r-1-8-other": {
      type: "result",
      code: "1.8",
      title: "Разное",
      description: "Используйте статью 1.8. Разное.",
      status: "ready"
    },
    "r-1-3-security": {
      type: "result",
      ...
      description: "Используйте статью 1.3. Обеспечение безопасности. В исходной схеме сюда ведёт вариант «Расходы учредителей». При необходимости перепроверьте эту связку.",
      tone: "Внимание: эта ветка выглядит нестандартно, лучше подтвердить у владельца процесса.",
      status: "warning"
    }
  }
};
